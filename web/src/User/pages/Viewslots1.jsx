  ...
  return (
    <div>
      <div className=" w-full h-full pt-14 bg-gradient-to-b from-cyan-500 to-indigo-500">
        <div align="center" className="text-white text-4xl"><b>Kannur International Airport</b></div>
              ...
              <div className="flex h-full">
                <div className="flex content-between pl-14 w-1/3 pt-12 rounded-2xl m-2 bg-gradient-to-b from-cyan-300 to-cyan-600   ">
                  <div className="w-1/2 grid">
                    <div>
                      <button className="text-white  transition ease-in-out delay-150 pt-2  hover:-translate-y-1 hover:scale-110 hover:bg-lime-400  duration-300   font-bold dark:font-bold   bg-lime-500 text-xl w-2/4 h-3/4  rounded-md ">
