...
export default function BookingList() {
  ...
  return (
    <div>
      < div className=" bg-gradient-to-b from-sky-500 to-indigo-500 w-full h-auto z-10 ">
      
        <div className="text-white text-8xl font-bold grid justify-center pt-20 pb-52  ">
